...
class Nao(Robot):
    ...
    """Initialize all robot sensors and actuators"""
    def findAndEnableDevices(self):
        ...
        # Display (verify name matches your Nao PROTO)
    ...
    def show_welcome_message(self):
        """Display welcome message on robot's screen"""
        ...
        self.display.drawText("\nPress 'C' to capture photo", 1, 40)
        self.display.drawText("\nPress 1-3 to change style", 1, 60)

    def print_style_menu(self):
        """Display current style selection"""
        ...
        self.display.drawText(style_text, 1, 100)
        self.display.setFont("Arial", 12, False)
